"""
URL configuration for sudent_management_system project.
...
from sudent_management_system import settings
from sudent_management_web import views, HodViews,  StaffViews, StudentViews
...
urlpatterns = [
    ...
    path('live_classroom',StaffViews.live_classroom, name="live_classroom"),
    ...
    path('join_live_classroom', StudentViews.join_live_classroom, name="join_live_classroom"),
    path('student_live_classroom',StudentViews.student_live_classroom, name="student_live_classroom"),
